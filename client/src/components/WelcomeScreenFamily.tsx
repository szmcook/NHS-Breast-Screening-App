...
function WelcomeScreenFamily(props:welcomeProps) {
  return(
    <div className="nhsuk-grid-row">
      <div className="nhsuk-grid-column-two-thirds">
        ...
        <p>To use this app you need to have a relative who:</p>

        <p>- Has breasts</p>
        <p>- Is aged between 50 and 71</p>
...
export default WelcomeScreenFamily;